const endUrl = {
  ...
  reports_manufacturer_stock_management_report:
    "user/reports/manufacturer-stock-management-report",
  reports_school_furniture_count_report:
    "user/reports/school-furniture-count-report",
